...
public class FileUtil
{
    ...
    public static string SelectTextFile()
    {
        ...
        {
            // openFileDialog.InitialDirectory = "c:\\"; // TODO - don't set or set to some other location?
            openFileDialog.Filter = "Text files (*.txt)|*.txt|All files (*.*)|*.*";
            openFileDialog.FilterIndex = 1;
            openFileDialog.RestoreDirectory = false; // Leaves current directroy set to location where file was found
